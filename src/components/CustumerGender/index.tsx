...
import CustumerGenderProps from "./props";

import { FC, useEffect, useState } from "react";
import { Box, Flex, Text } from "@chakra-ui/react";
import { defaultConfiguration } from "./constants";

const CustumerGender: FC<CustumerGenderProps> = ({ data }) => {
  ...
  return (
    <Box p="0" bg="transparent" w="100%" h="100%">
      <Flex>
        <Text variant="subtitle">Total de avaliações por gênero</Text>
      </Flex>
